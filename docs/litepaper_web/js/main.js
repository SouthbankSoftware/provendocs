;(function () {
	...
	var faqsAccordion = function() {
		...
		faqAcc.on('click', function(event){
			...
			$('.slide-accordion').find('.slide-body').slideUp(400, 'easeInOutExpo');

			if ( !$this.closest('.slide-accordion').find('.slide-body').is(':visible')) {
				$this.closest('.slide-accordion').addClass('active');
				$this.closest('.slide-accordion').find('.slide-body').slideDown(400, 'easeInOutExpo');
			} else {
				$this.closest('.slide-accordion').removeClass('active');
				$this.closest('.slide-accordion').find('.slide-body').slideUp(400, 'easeInOutExpo');
			}
	...
	var faqsWayPoint = function() {
		if ( $('#fh5co-info').length > 0 ) {
			$('#fh5co-info').waypoint( function( direction ) {
